...
- (void)setupNav
{
    ...
    NSBundle *currentBundle = [NSBundle bundleForClass:self.class];
    [self.collectionView registerNib:[UINib nibWithNibName:@"ImageCollectionViewCell" bundle:currentBundle] forCellWithReuseIdentifier:@"ImageCollectionViewCell"];
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    CGFloat width = (UIScreen.mainScreen.bounds.size.width - 4 - 6) / 4;
